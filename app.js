//logica de programacion para el sorteo de amigos

//ALmacenar nombres de los participantes (amigos)
let amigos = [];

// Ingresar un nombre en el campo de texto y ingresarlo a la lista de amigos
